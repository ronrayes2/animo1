    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          Welcome to Vercel Trick By <a href="https://animotvslash.carrd.co">Animo</a>
        </h1>
        ...
        <div className={styles.grid}>
          <a href="https://animotvslash.carrd.co" className={styles.card}>
          ...
          <a
            href="https://animotvslash.carrd.co"
